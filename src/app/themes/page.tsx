...
export default function ThemesPage() {
  ...
  const handleThemeSelect = (themeId: string) => {
    ...
    // Store selected theme in localStorage for use in catalogue creation
  ...
  const categories = [
    ...
    { id: 'bold', name: 'Bold', count: THEMES.filter(t => t.category === 'bold').length },
    { id: 'elegant', name: 'Elegant', count: THEMES.filter(t => t.category === 'elegant').length },
    { id: 'tech', name: 'Tech', count: THEMES.filter(t => t.category === 'tech').length },
  ]
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600">Select a design that matches your brand</p>
              </div>
            </div>
